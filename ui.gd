...
var game_lost_button_texture = preload("res://assety/igorassety/button_dead.png")
var game_won_button_texture = preload("res://assety/igorassety/button_cleared.png")
